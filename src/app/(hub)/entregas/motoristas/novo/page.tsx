...
export const metadata: Metadata = { title: 'Novo motorista · SR HUB' };
...
export default function NovoMotoristaPage() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-8 px-6 py-10 md:px-10">
      ...
      <header>
        <h1 className="font-display text-3xl text-white md:text-4xl">Novo motorista</h1>
      </header>
      <DriverForm />
    </div>
  );
