-- =============================================================
-- PROD CATCH-UP · Migrations 0037 → 0042 (com fix 0044)
--
-- Contexto: banco de produção estava em Fase 5 enquanto o código
-- estava em Fase 8. Este bundle aplica as 6 migrations pendentes
-- em ordem, permitindo que todas as features do HUB funcionem.
--
-- Fix aplicado: migration 0044 adiciona colunas SaaS que faltam
-- em 'invoices' (schema conflitante entre 0028 e 0039).
--
-- Ordem: 0037 → 0038 → 0044 (fix invoices) → 0039 → 0040 → 0041 → 0042
--
-- Todas as migrations abaixo são IDEMPOTENTES (usam 'if not exists',
-- 'drop policy if exists', 'create or replace'). Rodar novamente
-- em ambiente já parcial é seguro.
--
-- Gerado em: 2026-08-05T13:53:44Z
-- =============================================================
...
-- =============================================================
-- 0044_fix_invoices_saas_columns.sql
-- =============================================================
...
-- =============================================================
-- Verificação pós-aplicação (roda como SELECT separado):
-- select
